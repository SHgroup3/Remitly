...
export default function Navbar() {
  ...
  return (
    <>
      {/* Main Navbar */}
      <nav className="flex justify-between items-center px-6 md:px-12 py-4 bg-white shadow-sm">
        ...
        <div className="flex items-center space-x-6">
          ...
          <div className="bg-white-600 text-black font-bold rounded-full px-8 py-4 flex items-center space-x-6 shadow-md">
            <span
              onClick={() => setActive(active === "personal" ? null : "personal")}
              className={`cursor-pointer transition-transform duration-300 ${
                active === "personal"
                  ? "scale-110 font-semibold hover:bg-gray-200 rounded-full outline-gray"
                  : "opacity-80"
              }`}
            >
              Personal
            </span>
            <div className="w-[2px] h-6 bg-white/40" />
            <span
        ...
        {/* Right Side: Login, Signup, Help */}
        
        <div className="flex items-center space-x-4 text-lg font-bold">
               <Menu as="div" className="relative inline-block">
      <MenuButton className="inline-flex w-full justify-center gap-x-1.5 bg-white/10 px-3 
      py-2 text-sm font-semibold text-black-700 hover:bg-white/20 
      focus:outline-none focus:ring-0 focus:border-0 font-bold text-lg">
        <img
      ...
      <MenuButton className="inline-flex w-full justify-center gap-x-1.5 bg-white/10 px-3 
      py-2 text-sm font-semibold text-black-700 hover:bg-white/20 
      focus:outline-none focus:ring-0 focus:border-0 font-semibold text-lg">
        English
        <ChevronDownIcon aria-hidden="true" className="-mr-1 size-5 text-gray-400" />
      </MenuButton></Menu>
          <Link to="/help" className="text-gray-700 hover:text-teal-700 font-medium">
            Help
          </Link>
          <button className="text-gray-700 hover:text-teal-700 font-medium">
            Log in
          </button>
      ...
      >
        <div className="flex justify-left items-center bg-white-50 py-3 space-x-8 shadow-inner ml-8">
          {active === "personal" && (
            <>
              <Link
                to="/accounts"
