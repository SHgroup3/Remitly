      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-stretch gap-8">
          ...
          <div className="md:w-1/4 p-5 rounded-lg">
            ...
            <p className="text-sm text-gray-300 mb-3">
              I joined Remitly a week ago, already made 3 transfers — very
              satisfied!
            </p>
          ...
          <div className="md:w-1/4  p-5 rounded-lg">
            ...
            <p className="text-sm text-gray-300 mb-3">
              The network was bad but I managed to use Remitly without any
              problems.
            </p>
...
<div className="w-full max-w-3xl mx-auto px-4 py-12">
      <h2 className="text-2xl md:text-3xl font-bold text-center mb-8 text-gray-800">
        Get help with your Remitly Business account
      </h2>
